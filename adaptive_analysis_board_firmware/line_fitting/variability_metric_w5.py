"""Same as variability_metric.py, but with WINDOW=5 instead of 10 -- the V
companion to trend_score_windowed_w5.py's D, completing the W=5/10/20
...
V_OUT_PATH = os.path.join(RESULTS_DIR, "variation_windowed_results_w5.csv")
THRESHOLD_OUT_PATH = os.path.join(RESULTS_DIR, "variation_threshold_by_counter_w5.csv")
FLAGGED_OUT_PATH = os.path.join(RESULTS_DIR, "variation_attack_flags_w5.csv")
SUMMARY_OUT_PATH = os.path.join(RESULTS_DIR, "variation_detection_summary_w5.csv")
...
def main():
    ...
    print("\nh_V (W=5) (95th percentile of normal runs' max V), per counter:")
    ...
    print("\nPer-run detection summary (W=5) (a run counts as detected if ANY window exceeds h_V):")
