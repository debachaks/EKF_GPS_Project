...
(it's built from raw, unwindowed z), only the W=5 rolling mean z_bar does.
"""
...
def main():
    ...
    print("\nThresholds (W=5) (h_z: flat-pooled Q95; h_D/h_V: 95th pct of normal runs' max), per counter:")
