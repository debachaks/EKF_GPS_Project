"""V_final at W=5 -- identical construction to v_final_metric.py, just a
different window size, kept as a separate script/output set (rather than
overwriting the W=10 results) since other work (v_final_sweep.py,
...
V_OUT_PATH = os.path.join(RESULTS_DIR, "v_final_w5_v.csv")
VNEW_OUT_PATH = os.path.join(RESULTS_DIR, "v_final_w5_vneww.csv")
BASELINE_OUT_PATH = os.path.join(RESULTS_DIR, "v_final_w5_baseline.csv")
VSCORE_OUT_PATH = os.path.join(RESULTS_DIR, "v_final_w5_vscore.csv")
THRESHOLD_OUT_PATH = os.path.join(RESULTS_DIR, "v_final_w5_thresholds.csv")
SUMMARY_OUT_PATH = os.path.join(RESULTS_DIR, "v_final_w5_detection_summary.csv")
